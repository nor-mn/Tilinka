...
<header className="fixed top-0 w-full z-40">
    ...
    <div className="container px-6 pt-14 lg:px-8 tracking-normal">
      ...
      <section id="works" className="mx-auto max-w-6xl h-screen pt-25">
        <div className="">
          <strong className="text-5xl">Interactive / Softworks</strong>
          <div className="border rounded-xl border-gray-900 bg-gradient-to-r from-blue-200 to-cyan-200 overflow-hidden mt-10">
            <ul className="flex flex-wrap justify-center items-center text-sm font-medium text-center text-white bg-gray-900">
              <li>
                <a
                  href="#"
            ...
            <div className="h-85">
              <div className="grid grid-cols-[30%_1fr]">
                ...
                <p className="p-7 text-justify text-gray-600">
                  ...
                  illo sed cumque! Perferendis adipisci eius commodi deserunt
                  expedita, delectus totam fuga at quos quibusdam voluptas
                  impedit non fugiat libero, dolores tempore. Modi id, ad
                  quibusdam iusto reiciendis consequatur dignissimos? Voluptate
                  laborum quos tempora illum quibusdam labore aliquid atque modi
                  cupiditate.
                </p>
              </div>
            </div>
